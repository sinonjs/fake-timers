...
FakeTimers = require("./fake-timers-src");

},{"./fake-timers-src":21}],21:[function(require,module,exports){
"use strict";
...
},{"@sinonjs/commons":7}]},{},[20]);
const _timers = FakeTimers.timers;
export { _timers as timers };
const _createClock = FakeTimers.createClock;
export { _createClock as createClock };
const _install = FakeTimers.install;
export { _install as install };
const _withGlobal = FakeTimers.withGlobal;
export { _withGlobal as withGlobal };