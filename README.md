...
| `config.warpFactor`              | Number      | 1                                                                                                                                                                                                                              | changes the time passed in each internal tick by the warp factor (factors can't go below 0 and factors smaller than 1 will make ticks pass less time)                                                                                                                                        |
